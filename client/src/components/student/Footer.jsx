...
<div className='flex flex-col md:items-start items-center w-full'>
  ...
  <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit 
    amet consectetur adipisicing elit. Quo non, architecto numquam alias mollitia atque, voluptatum impedit harum magni nobis illo quod ex. Id unde ad, iusto recusandae reprehenderit dolorem!</p>
</div>
<div className='flex flex-col md:items-start items-center w-full'>
